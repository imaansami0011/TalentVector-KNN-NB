...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 relative overflow-x-hidden selection:bg-indigo-500/30">
      <style>{`
      ...
      <div className="absolute top-[-15%] left-[-8%] w-[700px] h-[700px] bg-indigo-600/10 rounded-full blur-[140px] animate-float-1 pointer-events-none z-0" />
      <div className="absolute bottom-[-15%] right-[-8%] w-[700px] h-[700px] bg-blue-500/10 rounded-full blur-[160px] animate-float-2 pointer-events-none z-0" />
        ...
        <div className="w-full px-6 md:px-12 lg:px-20 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <div className="w-8 h-8 rounded-lg bg-indigo-500/15 border border-indigo-500/25 flex items-center justify-center">
              <img src="/favicon.svg" alt="Talent Vector" className="w-4 h-4 object-contain" />
            </div>
            <div className="flex flex-col leading-none">
              <span className="font-sans font-extrabold text-sm uppercase tracking-widest text-white">
                Talent Vector
              </span>
      ...
      <section className="relative z-10 pt-24 pb-20 px-6 md:px-12 lg:px-20 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight leading-[1.08] max-w-3xl mx-auto mb-6">
        ...
        <div className="grid md:grid-cols-3 gap-6 max-w-[1400px] mx-auto">
          {[
            ...
            return (
              ...
              >
                <div className={`w-11 h-11 rounded-xl flex items-center justify-center transition-all duration-300 border ${classes.badge} ${classes.hover} group-hover:text-white group-hover:border-transparent`}>
                  {icon}
                </div>
          ...
          <div className="md:col-span-5 p-8 flex flex-col items-center justify-center bg-slate-900/30 gap-6">
            ...
            <div className="relative w-36 h-36 flex items-center justify-center">
              ...
              <div className="absolute flex flex-col items-center justify-center">
                <span className="text-4xl font-extrabold text-white">{similarityScore}%</span>
      ...
      <section id="roles" className="relative z-10 py-20 px-6 md:px-12 lg:px-20 lp-section-divider">
        ...
        <div className="flex max-w-[260px] mx-auto bg-slate-900/60 p-1 rounded-xl border border-slate-800 relative h-11 select-none mb-8">
          ...
          <button
            ...
            className={`flex-1 relative z-10 flex items-center justify-center gap-2 font-semibold text-xs tracking-wider transition-all duration-300 cursor-pointer rounded-lg ${roleTab === "recruiter" ? "text-indigo-300" : "text-slate-500 hover:text-slate-400"
              }`}
          >
          ...
          <button
            ...
            className={`flex-1 relative z-10 flex items-center justify-center gap-2 font-semibold text-xs tracking-wider transition-all duration-300 cursor-pointer rounded-lg ${roleTab === "seeker" ? "text-indigo-300" : "text-slate-500 hover:text-slate-400"
              }`}
          >
      ...
      <section className="relative z-10 py-20 px-6 md:px-12 lg:px-20 lp-section-divider">
        <div className="max-w-[1400px] mx-auto lp-glass-card rounded-2xl p-12 md:p-16 border border-white/8 shadow-2xl relative overflow-hidden text-center">
          ...
          <div className="relative z-10 space-y-5">
            ...
            <div className="pt-2">
              <Link to="/login">
                <button className="h-12 px-8 rounded-xl text-sm font-bold uppercase tracking-wider text-white lp-gradient-primary shadow-xl shadow-indigo-500/20 hover:opacity-90 hover:scale-[1.03] active:scale-[0.97] transition-all flex items-center gap-2 cursor-pointer mx-auto">
                  Start Sourcing Now
                  <ArrowRight className="w-4 h-4" />
                </button>
              </Link>
      ...
      <footer className="relative z-10 border-t border-white/5 bg-slate-950 select-none">
        <div className="w-full px-6 md:px-12 lg:px-20 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2">
            <img src="/favicon.svg" alt="Talent Vector" className="w-4 h-4 opacity-60 object-contain" />
            <span className="font-sans font-extrabold text-xs uppercase tracking-widest text-white/60">Talent Vector</span>
          </div>
