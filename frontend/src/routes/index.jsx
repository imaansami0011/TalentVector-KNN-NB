    ...
    <div className="min-h-screen bg-slate-950 text-slate-100 relative overflow-x-hidden selection:bg-primary/25">
      ...
      <header className="sticky top-0 z-50 glass-header select-none">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <Link to="/login">
            <button className="h-10 px-6 rounded-xl text-xs font-black uppercase tracking-widest text-white gradient-primary shadow-lg shadow-blue-500/20 hover:shadow-blue-500/30 hover:scale-[1.02] active:scale-[0.98] transition-all cursor-pointer">
              Login / Sign Up
            </button>
          </Link>
        </div>
      ...
      <section className="relative z-10 pt-20 pb-16 md:pt-28 md:pb-24 max-w-7xl mx-auto px-6 text-center space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
          <Link to="/login">
            <button className="h-12 px-8 rounded-2xl text-xs font-black uppercase tracking-widest text-white gradient-primary shadow-xl shadow-blue-500/25 hover:shadow-blue-500/35 hover:scale-[1.03] active:scale-[0.97] transition-all flex items-center gap-2 cursor-pointer">
              <span>Get Started</span>
              <ArrowRight className="w-4 h-4" />
            </button>
          </Link>
          <a href="#demo">
            <button className="h-12 px-8 rounded-2xl text-xs font-black uppercase tracking-widest text-slate-300 border border-slate-800 hover:border-slate-700 bg-slate-900/30 hover:bg-slate-900/50 hover:scale-[1.02] active:scale-[0.97] transition-all cursor-pointer">
      ...
      <section id="features" className="relative z-10 py-16 max-w-7xl mx-auto px-6 space-y-12">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400 max-w-md mx-auto">High-performance tools to filter out noise and fast-track hiring.</p>
        </div>

        <div className="grid md:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="glass-card p-8 rounded-3xl space-y-5 hover:-translate-y-1 transition-all duration-300 hover:border-primary/30 group">
            <div className="w-12 h-12 rounded-2xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 group-hover:bg-primary group-hover:text-white transition-all duration-300">
              <Cpu className="w-6 h-6" />
            </div>
            <div className="space-y-2">
              <h3 className="font-display font-black text-sm uppercase tracking-wider text-white">Neural Skill Matcher</h3>
          ...
          {/* Card 2 */}
          <div className="glass-card p-8 rounded-3xl space-y-5 hover:-translate-y-1 transition-all duration-300 hover:border-primary/30 group">
            <div className="w-12 h-12 rounded-2xl bg-blue-500/10 border border-blue-500/20 flex items-center justify-center text-blue-400 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300">
              <Layers className="w-6 h-6" />
            </div>
            <div className="space-y-2">
              <h3 className="font-display font-black text-sm uppercase tracking-wider text-white">Applicant Tracking</h3>
              <p className="text-xs text-slate-400 leading-relaxed font-medium">
          ...
          {/* Card 3 */}
          <div className="glass-card p-8 rounded-3xl space-y-5 hover:-translate-y-1 transition-all duration-300 hover:border-primary/30 group">
            <div className="w-12 h-12 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 flex items-center justify-center text-emerald-400 group-hover:bg-emerald-600 group-hover:text-white transition-all duration-300">
              <Mail className="w-6 h-6" />
            </div>
            <div className="space-y-2">
              <h3 className="font-display font-black text-sm uppercase tracking-wider text-white">Resend Dispatcher</h3>
              <p className="text-xs text-slate-400 leading-relaxed font-medium">
      ...
      <section id="demo" className="relative z-10 py-16 max-w-5xl mx-auto px-6 space-y-12">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400 max-w-md mx-auto">Toggle candidate skills below to watch the matching score recalculate in real-time.</p>
        </div>

        <div className="glass-card p-8 rounded-3xl grid md:grid-cols-12 gap-8 items-center border border-white/10 shadow-2xl relative overflow-hidden">
          
          {/* Interactive Skills Toggler - Left */}
          <div className="md:col-span-7 space-y-6">
            <div className="space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-[10px] font-black uppercase tracking-widest text-slate-400">Target JD Requirements</span>
                <span className="text-[9px] font-black text-indigo-400 uppercase tracking-widest bg-indigo-500/10 px-2 py-0.5 rounded-md">Fixed Target</span>
              </div>
              <div className="flex flex-wrap gap-2">
                {DEMO_JD_SKILLS.map(skill => (
                  <span key={skill} className="px-3 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider bg-slate-900 border border-slate-800 text-indigo-300">
                    {skill}
                  </span>
                ))}
              </div>
            ...
            <div className="space-y-2">
              <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 block">Extracted Candidate Skills (Click to toggle)</span>
              <div className="flex flex-wrap gap-2">
                {DEMO_ALL_SKILLS.map(skill => {
                  ...
                  return (
                    <button
                      ...
                      className={`px-3 py-1.5 rounded-xl text-xs font-black uppercase tracking-wider transition-all duration-200 cursor-pointer flex items-center gap-1.5 ${
                        isSelected
          ...
          <div className="md:col-span-5 flex flex-col items-center justify-center p-6 bg-slate-900/50 rounded-2xl border border-slate-800 relative min-h-[200px]">
            <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 mb-4">Match Strength</span>
            
            {/* Score circle */}
            <div className="relative w-32 h-32 flex items-center justify-center">
              {/* Glow background */}
              <div className="absolute inset-0 bg-primary/10 rounded-full blur-xl scale-95" />
              ...
              <div className="absolute flex flex-col items-center justify-center">
                <span className="text-3xl font-black font-display text-white transition-all duration-300">{similarityScore}%</span>
                <span className="text-[8px] font-black uppercase tracking-widest text-slate-500">Cosine Sim</span>
              </div>
            </div>

            {/* Formula visualization */}
            <div className="mt-6 text-[10px] font-mono text-slate-500 select-none">
              cos(θ) = (A · B) / (||A|| × ||B||)
            </div>
          </div>
      ...
      <section id="roles" className="relative z-10 py-16 max-w-5xl mx-auto px-6 space-y-12">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400 max-w-md mx-auto">Different dashboards designed explicitly for recruiter pipelines and candidate profile showcases.</p>
        </div>

        {/* Sliding Tab selector */}
        <div className="flex max-w-xs mx-auto bg-slate-900/80 p-1 rounded-2xl border border-slate-800 shadow-inner relative h-12 select-none">
          <div 
            className="absolute top-1 bottom-1 bg-white/5 rounded-xl border border-white/5 transition-all duration-500 ease-out z-0"
            style={{ 
              left: roleTab === "recruiter" ? "4px" : "calc(50% + 2px)", 
              width: "calc(50% - 6px)" 
            }}
          />
          <button
            onClick={() => setRoleTab("recruiter")}
            className={`flex-1 relative z-10 flex items-center justify-center gap-2 font-black text-[10px] uppercase tracking-widest transition-all duration-300 cursor-pointer ${
        ...
        {/* Tab content */}
        <div className="glass-card p-8 rounded-3xl min-h-[300px] flex items-center border border-white/5 relative overflow-hidden transition-all duration-500">
          {roleTab === "recruiter" ? (
            <div className="grid md:grid-cols-12 gap-8 items-center w-full animate-fadeIn">
              <div className="md:col-span-7 space-y-6">
                <div className="space-y-1.5">
                  <span className="text-[9px] font-black uppercase tracking-[0.2em] text-indigo-400">Employer Command Center</span>
                  <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tight font-display">Recruiter Pipeline</h3>
                  <p className="text-xs text-slate-400 font-medium">Manage open job pipelines, bulk parse resumes, and invite candidates directly.</p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-300 font-semibold">Bulk Resume Parser (supports PDFs, Word Documents, TXT)</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-300 font-semibold">Dynamic NLP parsing maps extracted candidate skills case-insensitively</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-300 font-semibold">1-Click branded interview invites sent via high-reputation email campaigns</p>
                  </div>
                </div>
                <Link to="/login">
                  <Button className="font-bold text-[10px] uppercase tracking-widest px-6 h-10 rounded-xl gradient-primary border-0 text-white shadow-md cursor-pointer flex items-center gap-1.5 mt-2">
                    <span>Access Recruiter Suite</span>
                    <ArrowRight className="w-3.5 h-3.5" />
                  </Button>
                </Link>
              </div>
              <div className="md:col-span-5 bg-slate-900/30 p-6 rounded-2xl border border-slate-800/60 shadow-inner flex flex-col justify-center min-h-[220px]">
                <div className="space-y-4 font-mono text-[10px] text-slate-500">
                  ...
                  <div className="flex justify-between pb-2">
                    <span>AI Scored Candidates</span>
            ...
            <div className="grid md:grid-cols-12 gap-8 items-center w-full animate-fadeIn">
              <div className="md:col-span-7 space-y-6">
                <div className="space-y-1.5">
                  <span className="text-[9px] font-black uppercase tracking-[0.2em] text-indigo-400">Professional Identity</span>
                  <h3 className="text-xl md:text-2xl font-black text-white uppercase tracking-tight font-display">Job Seeker Profiles</h3>
                  <p className="text-xs text-slate-400 font-medium">Build your verified candidate identity, parse your CV instantly, and get matched to jobs.</p>
                </div>
                <div className="space-y-3">
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-300 font-semibold">Instant CV parser creates your profile structure in seconds</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-300 font-semibold">Naive Bayes sector classifier predicts and categorizes your career sector</p>
                  </div>
                  <div className="flex items-start gap-3">
                    <CheckCircle2 className="w-5 h-5 text-indigo-400 shrink-0 mt-0.5" />
                    <p className="text-xs text-slate-300 font-semibold">Auto-match logic fetches top job openings aligned with your skill vectors</p>
                  </div>
                </div>
                <Link to="/login">
                  <Button className="font-bold text-[10px] uppercase tracking-widest px-6 h-10 rounded-xl gradient-primary border-0 text-white shadow-md cursor-pointer flex items-center gap-1.5 mt-2">
              ...
              <div className="md:col-span-5 bg-slate-900/30 p-6 rounded-2xl border border-slate-800/60 shadow-inner flex flex-col justify-center min-h-[220px]">
                <div className="space-y-4 font-mono text-[10px] text-slate-500">
                  ...
                  <div className="flex justify-between pb-2">
                    <span>Active Openings Match</span>
      ...
      <section className="relative z-10 py-16 md:py-24 max-w-5xl mx-auto px-6 text-center">
        <div className="glass-card p-12 md:p-16 rounded-[2.5rem] border border-white/10 shadow-2xl relative overflow-hidden space-y-6">
          ...
          <h2 className="text-3xl md:text-5xl font-black text-white tracking-tight uppercase font-display leading-none">
          ...
          <Link to="/login" className="inline-block pt-2">
            <button className="h-12 px-8 rounded-2xl text-xs font-black uppercase tracking-widest text-white gradient-primary shadow-xl shadow-blue-500/20 hover:shadow-blue-500/30 hover:scale-[1.03] active:scale-[0.97] transition-all flex items-center gap-2 cursor-pointer mx-auto">
