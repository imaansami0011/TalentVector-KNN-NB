...
function IdentityGateway() {
  ...
  return (
    <div className="min-h-screen w-full relative flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      {/* Floating Login Card */}
      <div className="relative z-30 max-w-[400px] w-full bg-white/95 backdrop-blur-[30px] rounded-[2rem] shadow-[0_30px_80px_-15px_rgba(0,0,0,0.5)] border border-white/60 overflow-hidden m-4 group">
        ...
        <div className="relative p-8 text-center bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-800 overflow-hidden">
          ...
          <Link to="/" className="text-2xl font-black text-white tracking-tight uppercase drop-shadow-md font-display focus-visible:outline-none">
            Talent Vector
          </Link>
