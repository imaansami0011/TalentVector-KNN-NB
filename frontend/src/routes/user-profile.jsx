...
function UserProfilePage() {
    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div className="lg:col-span-4 flex flex-col gap-6">
        ...
        <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-md hover:shadow-lg transition-all duration-300 flex flex-col gap-4">
          ...
          <label className="flex flex-col items-center justify-center w-full h-[280px] border-2 border-dashed border-slate-200 hover:border-primary/50 rounded-2xl cursor-pointer hover:bg-primary/5 transition-all duration-300 group relative overflow-hidden bg-slate-50/50">
            {isExtracting ? (
  ...
  const successModal = showSuccess && createPortal(
